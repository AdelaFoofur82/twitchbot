<template>
    <section>
            ...
            <div class="card-body text-white">
                ...
                <div class="row g-2 mb-3 align-items-end">
                    <div class="col-12 col-md-6">
                        ...
                        <input v-model="connectChannel" class="form-control bg-dark text-white border-light-subtle"
                            type="text" placeholder="si vacío = username" />
                    </div>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-success" @click="startBot"
                        :disabled="state.connectionStatus === 'connected' || isLoading">
                        {{ isLoading ? 'Conectando...' : 'Conectar bot' }}
                    </button>
                    <button class="btn btn-outline-light" @click="stopBot"
        ...
        <section class="card bg-dark border-light-subtle text-white mb-4">
            <div class="card-body text-white">
                ...
                <form class="d-flex gap-2 mb-3" @submit.prevent="submitChatMessage">
                    <input v-model="chatInput" ref="chatInputRef"
                        class="form-control bg-dark text-white border-light-subtle" type="text"
                ...
                <p class="small text-white mb-3">
                    Anuncios: <code>/announce mensaje</code>, <code>/announce -[green|orange|blue|purple]
                        mensaje</code>.
                </p>

                <div class="small text-white mb-2">Mensajes recientes</div>
                <ul class="list-group list-group-flush">
                    <li v-for="event in recentChatMessages" :key="event.id"
        ...
        <section class="card bg-dark border-light-subtle text-white g-3 mb-4">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card h-100 bg-dark border-light-subtle text-white">
                        <div class="card-body text-white">
                            <h3 class="h6">Bits</h3>
                            <ul class="list-group list-group-flush">
                                <li v-for="event in state.events.bits" :key="event.id"
                                    class="list-group-item bg-dark text-white px-0">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card h-100 bg-dark border-light-subtle text-white">
                        <div class="card-body text-white">
                            ...
                            <ul class="list-group list-group-flush">
                                <li v-for="event in state.events.followers" :key="event.id"
                                    class="list-group-item bg-dark text-white px-0">
                                    Nuevo follower: <strong>{{ event.user }}</strong>
                                </li>
                                <li v-if="!state.events.followers.length"
                                    class="list-group-item bg-dark text-white px-0">
                                    Sin eventos aún
                                </li>
                            </ul>
                ...
                <div class="col-12 col-lg-4">
                    <div class="card h-100 bg-dark border-light-subtle text-white">
                        <div class="card-body text-white">
                            <h3 class="h6">Subs</h3>
                            <ul class="list-group list-group-flush">
                                <li v-for="event in state.events.subscriptions" :key="event.id"
                                    class="list-group-item bg-dark text-white px-0">
                                    {{ event.user }} se suscribió ({{ event.tier }})
                                </li>
                                <li v-if="!state.events.subscriptions.length"
                                    class="list-group-item bg-dark text-white px-0">
                                    Sin eventos aún
                                </li>
                            </ul>
